...
const FibonacciCalculatorWidget: React.FC = () => {
  ...
  useEffect(() => {
    ...
    iframe.src = "https://ssltools.investing.com/fibonacci-calculator/index.php?force_lang=1";
...
export default FibonacciCalculatorWidget;
