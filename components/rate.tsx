...
const Rate = () => {
  useEffect(() => {
    ...
    const widgetContainer = document.querySelector('.tradingview-widget-container__widget51');
    if (widgetContainer) {
  ...
  return (
    <div className="tradingview-widget-container51 w-full">
      <div className="tradingview-widget-container__widget51"></div>
      <div className="tradingview-widget-copyright51">
