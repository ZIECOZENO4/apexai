...
const Rate2 = () => {
  useEffect(() => {
    ...
    const widgetContainer = document.querySelector('.tradingview-widget-container__widget512');
    if (widgetContainer) {
  ...
  return (
    <div className="tradingview-widget-container512 w-full">
      <div className="tradingview-widget-container__widget512"></div>
      <div className="tradingview-widget-copyright512">
